...
<body >
	...
	<div id="logoArea" class="navbar" >
		...
		<div class="navbar-inner" style="height:90px; padding-top:10px; ">
			 <a class="brand" href="index.php?id=<?php echo (isset($_SESSION['customer_name'])) ? $_SESSION['id'] : 'unknown'; ?>" style="opacity:0.8;margin-top:2px">
				<img width="165px" src="./admin/upload/<?php echo $_SESSION['web-img']; ?> " alt="image" />
			</a>
					...
					<li class="">
						...
						<div id="login" class="modal hide fade in" tabindex="-1" role="dialog" aria-labelledby="login" aria-hidden="false">
							...
							<div class="modal-body">
								...
								<?php
								if (isset($_POST['signin'])) echo "<br> <br>";
								if (isset($userunavailable)) echo '<div class="alert alert-danger">User Unavailable.</div>';
								else if (isset($incorrectpwd)) echo '<div class="alert alert-danger">Incorrect Password.</div>'
								?>
							</div>
						</div>
					</li>
